...
func (SL_ENGINE_VAL *ENGINE_Value) SL_RetrieveDataType() Type_Object        { return ENGINE_TYPE }     // SLC_Object interface   | Engine value data type
func (SL_ModuleDataType *Module) SL_RetrieveDataType() Type_Object          { return MODULE }          // SLC_Object interface   | Module data type
...
func (ENGINEK *ENGINE) SL_ExtractNodeValue() string {
	return ENGINEK.Token.Literal
...
} // Token Literal        | Returns literal of importing list
