...
func GenerateErrorDeveloper() ErrorSystemReturn {
	return ErrorSystemReturn{
		Message:    "Error system function call was not found, developer error ( not enough arguments in call to error map) ",
