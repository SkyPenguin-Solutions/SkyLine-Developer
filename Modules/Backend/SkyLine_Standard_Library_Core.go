...
func Environment_GetEnvironmentPath(arguments ...SLC_Object) SLC_Object {
	...
	if arguments[0].SL_RetrieveDataType() != STRING {
...
func Environment_SetEnvironment(arguments ...SLC_Object) SLC_Object {
	...
	if arguments[1].SL_RetrieveDataType() != STRING {
		return NewError("argument must be a string, got=%s",
...
func RunFileInjFromFileToFile(args ...SLC_Object) SLC_Object {
	return &Boolean_Object{
		Value: SkyLine_External_Forensics.Image_Controller_Function_External_2_Inject_Into_File(
			args[0].SL_InspectObject(), // input file
			args[1].SL_InspectObject(), // output file
			args[2].SL_InspectObject(), //
		),
	}
}
...
func RunPayloadInjectionRegular(args ...SLC_Object) SLC_Object {
	return &Boolean_Object{
		// was : SkyLine_External_Forensics.CreationSettings.Output
...
const (
	...
	ROKU_KEYPRESS_LAUNCH      = "http://%s:8060/launch/%s"
	ROKU_KEYPRESS_INSTALL     = "http://%s:8060/install/%s?contentid=%s&MediaType=%s"
	ROKU_KEYPRESS_DISABLE_SGR = "http://%s:8060/query/sqrendezvous/untrack"
	ROKU_KEYPRESS_ENABLE_SGR  = "http://%s:8060/query/sqrendezvous/track"
	ROKU_KEYPRESS_TV          = "http://%s:8060/query/tv-channels"
	ROKU_KEYPRESS_SGNODE      = "http://%s:8060/query/sgnodes"
	ROKU_KEYPRESS_ACTIVETV    = "http://%s:8060/query/tv-active-channel"
	ROKU_KEYPRESS_DIAL        = "http://%s:8060/dial/dd.xml"
	ROKU_KEYPRESS_BROWSE      = "http://%s:8060/search/browse?keyword=%s"
	ROKU_KEYPRESS_DEVINFO     = "http://%s:8060/query/device-info"
	ROKU_KEYPRESS_DEVAPPS     = "http://%s:8060/query/apps"
	ROKU_KEYPRESS_DEVACTIVE   = "http://%s:8060/query/active-app"
)
...
var StringFunctionMap = map[string]InvokeMethFunctionStr{
	...
	"to_f": func(Value string, Env Environment_of_environment, args ...SLC_Object) SLC_Object {
	...
	"to_i": func(Value string, Env Environment_of_environment, args ...SLC_Object) SLC_Object {
	...
	"to_b": func(Value string, Env Environment_of_environment, args ...SLC_Object) SLC_Object {
...
func RegisterForensics() {
	RegisterBuiltin("forensics.PngChunkCount", func(env *Environment_of_environment, args ...SLC_Object) SLC_Object {
		return (Run_Forensics_Metadata_PNG_GetNumChunks(args...))
	})
	RegisterBuiltin("forensics.PngSettingsNew", func(env *Environment_of_environment, args ...SLC_Object) SLC_Object {
		return (RunSettings(args...))
	})
	RegisterBuiltin("forensics.InjectPNG", func(env *Environment_of_environment, args ...SLC_Object) SLC_Object {
		return (RunInject(args...))
	})
	RegisterBuiltin("forensics.InjectImage", func(env *Environment_of_environment, args ...SLC_Object) SLC_Object {
		return (RunFileInjFromFileToFile(args...))
	})
	RegisterBuiltin("forensics.FindSigUnknownFile", func(env *Environment_of_environment, args ...SLC_Object) SLC_Object {
		return (RunFileVerification(args...))
	})
	RegisterBuiltin("forensics.CheckZIPSig", func(env *Environment_of_environment, args ...SLC_Object) SLC_Object {
		return (RunZipCheck(args...))
	})
	RegisterBuiltin("forensics.CreationNew", func(env *Environment_of_environment, args ...SLC_Object) SLC_Object {
		return (RunFileNewSettings(args...))
	})
	RegisterBuiltin("forensics.InjectRegular", func(env *Environment_of_environment, args ...SLC_Object) SLC_Object {
		return (RunPayloadInjectionRegular(args...))
	})
	RegisterBuiltin("forensics.CreateImage", func(env *Environment_of_environment, args ...SLC_Object) SLC_Object {
...
func RegisterRokuIoTDatabase() {
	...
	RegisterVariable("Roku.KeyPressPlay", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressUp", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressDown", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressLeft", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressRight", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressSelect", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressRewind", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressFFW", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressOptions", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressPause", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressBack", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressPoweroff", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressVolumeUp", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressVolumeDown", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressVolumeMute", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressDeviceDown", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressDeviceUp", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressDevAppLaunch", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressDevAppInstall", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressDevDisableSGR", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressDevEnableSGR", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressDevTV", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressDevSGNODES", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressDevActiveTVS", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.KeyPressDevDial", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.DeviceBrowse", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.DeviceInformation", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.DeviceApplications", &String{Value: ROKU_KEYPRESS_HOME})
	RegisterVariable("Roku.DeviceActiveApplications", &String{Value: ROKU_KEYPRESS_HOME})
}
